...
#import OpenCV modulepath = r"C:\Users\rshinwari\Documents\Ali Data\Kabul University\Thesis\myCode_python\training"
...
#path = r"C:\Users\rshinwari\Documents\Ali Data\Kabul University\Thesis\myCode_python\training"
...
subjects = ["", "img1", "img2","img3","img4"]
mypath = r"D:\Ali Data_25_june_2018\Kabul University\Thesis\myCode_python\training"
#mytestpath = r"C:\Users\rshinwari\Documents\Ali Data\Kabul University\Thesis\myCode_python\testing"
...
def prepare_training_data(path):
    ...
    for dir_name in dirs:
        ...
        subject_dir_path = mypath + "/" + "s" + str(label)
        ...
        for image_name in subject_images_names:
            ...
            #image_path = subject_dir_path + "/" + "01.jpg"
...
faces, labels = prepare_training_data(mypath)
print("Data prepared")
...
#opencv_contrib.train(faces, np.array(labels))
...
#load test images    
test_img1 = cv2.imread(r"D:\Ali Data_25_june_2018\Kabul University\Thesis\myCode_python\testing1\s1\9326871.20.jpg")
test_img2 = cv2.imread(r"D:\Ali Data_25_june_2018\Kabul University\Thesis\myCode_python\testing1\s2\9332898.20.jpg")
test_img3 = cv2.imread(r"D:\Ali Data_25_june_2018\Kabul University\Thesis\myCode_python\testing1\s3\9338446.20.jpg")
test_img4 = cv2.imread(r"D:\Ali Data_25_june_2018\Kabul University\Thesis\myCode_python\testing1\s4\9338454.20.jpg")
...
cv2.imshow(subjects[4], cv2.resize(predicted_img4, (400, 400)))
cv2.waitKey(0)
cv2.destroyAllWindows()
cv2.waitKey(1)
cv2.destroyAllWindows()
